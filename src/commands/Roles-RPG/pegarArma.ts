...
export const slash: Command = {
    ...
    run: async ({interaction}) => {
        ...
        try {
            ...
            return await interaction.reply({ content: "Arma adicionada com sucesso!"})
            
        } catch (err) {

            console.log(err);
            return await interaction.reply({ content: "Algo deu errado ao Adicionar a Arma à sua Ficha."})
